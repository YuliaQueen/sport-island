...
class SI_Widget_Info extends WP_Widget {
	public function __construct() {
		parent::__construct(
			'si_widget_info',
			'SI - контактная информация',
			[
				'name'        => 'SI - контактная информация',
				'description' => 'Выводит контактную информацию'
			]
		);
	}
	...
	public function widget( $args, $instance ) {
		switch ( $instance['var'] ) {
			...
			case 'phone':
				...
				?>
                <a href="<?php echo 'tel:' . $tel ?>" class="widget-phone"><?php echo $instance['info']; ?> </a>
			...
			case 'mail':
				?>
                <a href="<?php echo $instance['info']; ?>" class="widget-email"><?php echo $instance['info']; ?></a>
				<?php
